...
function LoginPageContent() {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-[#f7f8fa] px-4 py-12">
      {/* Logo */}
      ...
      <div className="w-full max-w-md rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
        <div className="border-b border-slate-100 px-6 py-4">
          <h1 className="text-lg font-black text-black">선생님 로그인</h1>
      ...
      <p className="mt-6 text-center text-xs font-medium text-slate-400">
        학생은 로그인 없이{' '}
        <Link href="/lobby" className="font-black text-sky-500 hover:underline">
          게임 코드로 입장
        </Link>
        하세요
      </p>
