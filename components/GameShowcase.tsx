...
const games: GameData[] = [
    ...
    },
    {
        ...
        keywords: ['🐕 홍팀 vs 청팀 🐺', '❄️ 눈덩이 공격', '💎 장비 선택', '🌨️ 폭설 주의보'],
        description: '홍팀과 청팀으로 나뉘어 눈싸움! 퀴즈로 눈뭉치를 장전해 상대팀을 모두 얼리면 승리해요.',
        accentColor: '#38bdf8',
    ...
    },
    {
        ...
        imageSrc: '/title/fishing.svg',
        titleImageSrc: '/title/fishing.svg',
